...
jpegFiles = dir('dataset/*.jpg'); 
numfiles = length(jpegFiles);
mydata = cell(1, numfiles);

for k = 1:numfiles 
  mydata{k} = imread(strcat('dataset/', jpegFiles(k).name)); 
end
